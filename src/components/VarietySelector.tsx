...
const VarietySelector: React.FC<VarietySelectorProps> = ({
  ...
  const getCategoryColor = (category: string) => {
    const colors: { [key: string]: string } = {
      produce: 'from-emerald-500 to-teal-500',
      dairy: 'from-blue-500 to-cyan-500',
      bakery: 'from-amber-500 to-orange-500',
      meat: 'from-red-500 to-pink-500',
      pantry: 'from-indigo-500 to-purple-500',
        ...
        >
          ...
          >
            ...
            <div className="flex items-center space-x-3 mb-4">
              <div className={`w-12 h-12 bg-gradient-to-r ${getCategoryColor(category)} rounded-xl flex items-center justify-center text-white text-lg shadow-lg`}>
                {getCategoryIcon(category)}
              </div>
              <div>
                <h3 className="text-lg font-bold text-white">Product Selection</h3>
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg"
                >
            ...
            <div className="mt-4 p-3 bg-gray-700/30 rounded-xl">
              <p className="text-gray-400 text-xs text-center">
                💡 Voice command: "Select option [number]" or "Choose the [first/second] one"
              </p>
            </div>
          </motion.div>
        </motion.div>
